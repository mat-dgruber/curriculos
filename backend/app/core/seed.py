    ...
    async with async_session() as session:
        ...
        jobs = [
            ...
            Job(
                ...
                location="Worldwide",
                platform="remotive",
                url="https://remotive.com/job/full-stack-dev-001",
                description="Build and maintain web applications using modern frameworks. React, Node.js, PostgreSQL. Fully remote, async-friendly culture.",
                requirements=json.dumps(["React", "Node.js", "PostgreSQL", "TypeScript"]),
                salary_range="$80,000 - $120,000/year",
                score=72,
                status="Nova",
                found_at=datetime.utcnow() - timedelta(hours=3),
            ),
            Job(
                id="job-7",
                ...
                location="São Paulo, SP",
                platform="jooble",
                url="https://jooble.org/job/backend-dev-001",
                description="Vaga para desenvolvedor backend pleno com experiência em Python, FastAPI e Docker. Projetos internacionais.",
                requirements=json.dumps(["Python", "FastAPI", "Docker", "PostgreSQL"]),
                salary_range="R$ 9.000 - R$ 14.000",
                score=68,
                status="Nova",
                found_at=datetime.utcnow() - timedelta(hours=6),
            ),
        ]
