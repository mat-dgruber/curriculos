    ...
    <div class="p-4 md:p-8">
      ...
      @if (loading()) {
        ...
        <div class="bg-dark-surface border border-error/20 rounded-xl p-8 text-center">
          ...
          <button class="btn-primary text-sm mt-3" (click)="loadSettings()">
            Tentar novamente
          </button>
        </div>
      } @else {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="bg-dark-surface border border-dark-border rounded-2xl p-6">
            ...
            <div class="flex gap-2">
              ...
              />
              <button class="btn-secondary text-sm shrink-0" (click)="addKeyword()">
                + Adicionar
              </button>
            </div>
          </div>
          ...
          <div class="bg-dark-surface border border-dark-border rounded-2xl p-6">
            ...
            <div class="flex gap-2">
              <input
                ...
                (keyup.enter)="addRole()"
              />
              <button class="btn-secondary text-sm shrink-0" (click)="addRole()">
                + Adicionar
              </button>
            </div>
          </div>
          ...
          <div class="bg-dark-surface border border-dark-border rounded-2xl p-6">
            ...
            <div class="flex gap-2">
              ...
              />
              <button class="btn-secondary text-sm shrink-0" (click)="addLocation()">
                + Adicionar
              </button>
            </div>
          </div>
                ...
                <label class="flex items-center gap-3 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p class="text-text-muted text-xs">
                      Enviar currículo para vagas com score ≥ 80%
                    </p>
                  </div>
                </label>
              </div>
